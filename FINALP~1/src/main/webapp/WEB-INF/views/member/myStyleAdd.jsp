...
font-size:7em;">연애가 쉬워지는 곳,<br> 연애인</h1>
        ...
        <section id="feature" class="feature p-top-100">
            ...
            <div class="container">
                ...
                <form action="/insertMyStyle.do" method="get">
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 연애 중 어떤 연령대를 가장 많이 만났나요?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 부먹 찍먹 중 무엇을 선택 하시겠습니까?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 산과 바다 어디로 여행을 가고 싶은가요?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 평소 밥과 면중 어떤 것을 더 즐겨먹나요?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 전화와 문자중 어떤 것을 선호하는 것은?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 중국집에 왔습니다. 둘 중 뭘 드실건가요?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 술을 드실 때 무슨파 인가요?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 애인과 외식을 하러 가는 중 입니다. 어느쪽을 선택 ?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 엄청 더운 여름과 엄청 추운 겨울 중 어느쪽을 택할 것인가요?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님 앞에 음식이 있습니다. 어떤맛이 끌리시나요?</h1>
                    ...
                    <div class="radioBox" style="text-align:center">
                        <h1> ${m.memberId }님은 절벽에 친구와 애인이 매달려있습니다. 어떤 것을 택하겠습니까?</h1>
