...
<!-- Preloader -->
      ...
      <div class="container">
               <h1> ${m.memberId }님의 스타일은? (수정 화면)</h1>
               <br>
<form action="/myStyleAdd.do" method="get">
   ...
   혈액형 : 
   <c:choose>
      <c:when test="${ms.bloodType eq 'A형'}">
         <input type="radio" name="bloodType" value="A형" checked="checked">A형
   ...
   <c:when test="${ms.drinkCount eq '주3회이상'}">
   ...
   <c:when test="${ms.drinkCount eq '주2회'}">
   ...
   <c:when test="${ms.drinkCount eq '주1회'}">
           <input type="radio" name="drinkCount" value="주3회이상" >주3회이상
            <input type="radio" name="drinkCount" value="주2회">주2회
   ...
   <c:when test="${ms.drinkCount eq '월2회'}">
           <input type="radio" name="drinkCount" value="주3회이상" >주3회이상
            <input type="radio" name="drinkCount" value="주2회">주2회
            <input type="radio" name="drinkCount" value="주1회">주1회
   ...
   <c:when test="${ms.drinkCount eq '안마신다'}">
           <input type="radio" name="drinkCount" value="주3회이상" >주3회이상
            <input type="radio" name="drinkCount" value="주2회">주2회
            <input type="radio" name="drinkCount" value="주1회">주1회
          <input type="radio" name="drinkCount" value="월2회">월2회
   ...
   <br>
     연령대 : 
     <c:choose>
     <c:when test="${ms.association eq '연하'}">
         ...
         <c:when test="${ms.association eq '연상'}">
         ...
         <c:when test="${ms.association eq '동갑'}">
           <input type="radio" name="association" value="연하" >연하
           <input type="radio" name="association" value="연상">연상
         ...
         <c:when test="${ms.association eq '상관없음'}">
           <input type="radio" name="association" value="연하" >연하
           <input type="radio" name="association" value="연상">연상
           <input type="radio" name="association" value="동갑">동갑
   ...
   <c:if test="${sessionScope.member.memberGender == '남자' }">
      나의 키(남) :
        <c:choose>
           <c:when test="${ms.height eq '170이하'}">
           ...
           <c:when test="${ms.height eq '171~175'}">
           ...
           <c:when test="${ms.height eq '176~180'}">
                   <input type="radio" name="height" value="170이하" >170cm이하
                 <input type="radio" name="height" value="171~175">171~175
           ...
           <c:when test="${ms.height eq '181~185'}">
                   <input type="radio" name="height" value="170이하" >170cm이하
                 <input type="radio" name="height" value="171~175">171~175
                  <input type="radio" name="height" value="176~180">176~180
           ...
           <c:when test="${ms.height eq '185이상'}">
                   <input type="radio" name="height" value="170이하" >170cm이하
                 <input type="radio" name="height" value="171~175">171~175
                  <input type="radio" name="height" value="176~180">176~180
                  <input type="radio" name="height" value="181~185">181~185
   ...
   <c:if test="${sessionScope.member.memberGender eq '여자' }">
        ...
        나의 키(여) :
        <c:choose>
        <c:when test="${ms.height eq '160cm이하'}">
        ...
        <c:when test="${ms.height eq '161~165'}">
        ...
        <c:when test="${ms.height eq '166~170'}">
              <input type="radio" name="height" value="160cm이하" >160cm이하
                 <input type="radio" name="height" value="161~165">161~165
   ...
   <br>
     나의 얼굴 : 
     <c:choose>
     <c:when test="${ms.style02 eq '강아지상'}">
     ...
     <c:when test="${ms.style02 eq '고양이상'}">
     ...
     <c:when test="${ms.style02 eq '병아리상'}">
                  <input type="radio" name="style02" value="강아지상">강아지상
                  <input type="radio" name="style02" value="고양이상">고양이상
                  <input type="radio" name="style02" value="공룡상">공룡상
                  <input type="radio" name="style02" value="곰상">곰상
     ...
     <c:when test="${ms.style02 eq '호랑이상'}">
                  <input type="radio" name="style02" value="강아지상">강아지상
                  <input type="radio" name="style02" value="고양이상">고양이상
                  <input type="radio" name="style02" value="공룡상">공룡상
                  <input type="radio" name="style02" value="곰상">곰상
     ...
     <c:when test="${ms.style02 eq '다람쥐상'}">
                  <input type="radio" name="style02" value="강아지상">강아지상
                  <input type="radio" name="style02" value="고양이상">고양이상
                  <input type="radio" name="style02" value="공룡상">공룡상
                  <input type="radio" name="style02" value="곰상">곰상
