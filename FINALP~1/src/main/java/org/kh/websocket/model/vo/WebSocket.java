...
import org.kh.websocket.model.util.ChatUtil;
...
//작성 순서 : afterConnectionEstablished(서버접속시)
// afterConnectionClosed(서버 연결 끊을시)
// handleTextMessage( 서버가 메세지를 받았을때)
//기타 필요한 메소드는 중간중간 필요에따라 작성
//서버 연결에 필요한 웹소켓 변수들도 필요에 따라 추가
...
public class WebSocket extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
    	...
    	logger.info("세션추가:"+session.getId()+"접속자아이디:"+mem.getMemberId()+" 현재채팅접속자:"+sessionList.size()+"명");
...
//통신 연결끊었을때실행
    ...
    id+"]</b> 님이 <b style='color:blue'>접속</b>하셨습니다.</a>").build();
    	System.out.println(jsonObject+"JsonDataOpen");
    ...
    public String JsonDataClose(String id) {
    	...
    	System.out.println(jsonObject+"JsonDataClose");
    	StringWriter write = new StringWriter();
    ...
    public String JsonWisper(String fromId, Object msg) {
    	...
    	System.out.println(jsonObject+"JsonWisper");
    	StringWriter write = new StringWriter();
    ...
    public String JsonRoom(String roomNames) {
    	...
    	System.out.println(jsonObject+"JsonRoom");
    	StringWriter write = new StringWriter();
    ...
    private List<String> informUser(Map<WebSocketSession,String> maplist, String room) throws Exception {
    	...
    	System.out.println(sessionIds+"informUser");
			while(sessionIds.hasNext()) {
    		WebSocketSession sessionId = sessionIds.next();
    ...
    public String getRoomName(String name) throws Exception{
    	...
    	System.out.println(roomList+"getRoomName");
